...
am4core.ready(function() {
    ...
    buttonsAndChartContainer.height = am4core.percent(43); // make this bigger if you want more space for the chart
    ...
    function changeDataType(name) {
        ...
        imageTemplate.tooltipText = "[bold]{name}: {value}[/] [font-size:10px]\n" + currentTypeName;
